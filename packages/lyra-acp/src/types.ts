export const ACP_METHODS = [
  "session/new", "session/load", "session/prompt", "session/update", "session/cancel", "session/fork",
...
export interface AcpDaemonOptions { handlers: AcpHandlers; requestTimeoutMs?: number; serverName?: string; serverVersion?: string; }
